package com.tzt.customizekt.study.view.example;
...
import com.tzt.customizekt.study.view.InterceptTouchHelper;
import com.tzt.customizekt.study.view.MeasureUtils;
import com.tzt.customizekt.study.view.ScrollHelper;
import com.tzt.customizekt.study.view.ViewScrollHelper;
...
public class FreeScroll extends FrameLayout {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        // 1.先制作出属于自己的测量规格，对内间距进行处理(原onMeasure方法中的测量规格？)
        ...
        // 8.MeasureUtils.getMeasuredDimension主要根据父视图限制计算出自身安全的尺寸大小。
