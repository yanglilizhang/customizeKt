...
class LoadButton : View {
    ...
    private val mChangeToLoadAnimal by lazy {
        ValueAnimator.ofFloat(0f, 1f).apply {
            ...
            addUpdateListener {
                ...
                Log.e("**", "----1---->mPathPercent=$mCurrentW")
                invalidate()
            }
            doOnEnd {
    ...
    private val mChangeToButtonAnimal by lazy {
        ValueAnimator.ofFloat(1f, 0f).apply {
            ...
            addUpdateListener {
                mCurrentW = (width / 2f - height / 2f) * it.animatedValue as Float
                mAlpha = 255 - 255 * it.animatedValue as Float
                Log.e("**", "-----2--->mPathPercent=$mCurrentW")
                invalidate()
            }
        }
    }
    ...
    private val mLoadPathAnimator by lazy {
        ValueAnimator.ofFloat(0f, 1f).apply {
            ...
            addUpdateListener {
                ...
                Log.e("**", "-------->mPathPercent=$mPathPercent")
                invalidate()
            }
        }
    }
    ...
    override fun onDraw(canvas: Canvas?) {
        ...
        if (mCirclePath == null) {
            ...
            Log.e(
                "**", "left=${width / 2f - height / 2f},top=$mStorkenWidth," +
                        "right=${width / 2f + height / 2f},bottom=${height.toFloat() - mStorkenWidth}"
            )
        ...
        canvas?.drawRect(mRect!!, mPathPaint)
